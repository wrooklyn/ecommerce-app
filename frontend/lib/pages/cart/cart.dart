...
import 'package:ecommerce/widgets/no_data_page.dart';
            ...
            Positioned(
              ...
              child: prevPage!="screen"? Row(
                children:<Widget>[
                  ...
                  Expanded(
                    flex:30,
                    child: Align(alignment: Alignment.center, child:BoldTitle(text: "Your Cart", color: AppColors.darkBlue, size: Dimensions.font26*0.9)),
                  )
                ]
              ): Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children:[
                  BoldTitle(text: "Your Cart", color: AppColors.darkBlue, size: Dimensions.font26*0.9),
                ]
              )
            ),
            GetBuilder<CartController>(builder: (controller){
              return controller.getCart.isNotEmpty? 
                Positioned(
                ...
                ) : const NoDataPage(text: "Your shopping cart is empty.");
            })
          ]
        ),
        bottomNavigationBar: GetBuilder<CartController>(builder:(controller){
        return controller.getCart.isNotEmpty? Container(
