...
module.exports={
    productValidator:[
        ...
        body('category').exists().withMessage( 'Category field is required.').isString().withMessage('Category must be a string.').isIn(['popular', 'recommended', 'drinks']).withMessage('Category must be either popular or recommended'),
      ]
};